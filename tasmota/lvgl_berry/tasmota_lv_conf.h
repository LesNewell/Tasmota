...
#define LV_USE_DRAW_SW 1
    ...
    #ifdef ESP32
        #define LV_DRAW_SW_SUPPORT_RGB565A8 1       // TASMOTA - ESP32 only, fixes image rotate/scale for RGB565
    #else
...
#define LV_USE_LOG 0
    ...
    #define LV_LOG_LEVEL LV_LOG_LEVEL_WARN      // TASMOTA
 ...
 *  released immediately after use. */
 #define LV_IMG_CACHE_DEF_SIZE_PSRAM     (2048*1024)     // TASMOTA - used in code
 #define LV_IMG_CACHE_DEF_SIZE_NOPSRAM   (32*1024)       // TASMOTA - used in code
...
#define LV_FONT_ICONS_18 1                  // TASMOTA
...
#define LV_FS_DEFAULT_DRIVER_LETTER 'A'     // TASMOTA
